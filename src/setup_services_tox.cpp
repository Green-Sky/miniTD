...
bool setup_service<MM::Services::ScreenDirector>(MM::Engine& engine, [[maybe_unused]] int argc, [[maybe_unused]] char** argv) {
	...
	mini_td::Screens::create_game_mp_host(engine, sd.screens["mini_td::Screens::game_mp_host"]);
	mini_td::Screens::create_game_mp_client(engine, sd.screens["mini_td::Screens::game_mp_client"]);
